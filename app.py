...
with app.app_context():
    ...
    try:
        ...
        # Add missing columns to users table (note: 'user' is reserved keyword in PostgreSQL)
        if 'user' in inspector.get_table_names():
            ...
            with db.engine.connect() as conn:
                ...
                if 'is_online' not in user_columns:
                    conn.execute(db.text('ALTER TABLE "user" ADD COLUMN is_online BOOLEAN DEFAULT FALSE'))
                conn.commit()
